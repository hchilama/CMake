...
SYCL Library to veriy SYCL compatability of CMAKE_CXX_COMPILER
...
.. note::
  ...
  that supports dpcpp ( eg: IntelLLVMCompiler) both DPCPP and SYCL
...
if(nocmplr)
  message(ERROR " CMAKE_CXX_COMPILER not set!!")
endif()
...
if( NOT "x${CMAKE_CXX_COMPILER_ID}" STREQUAL "xClang" AND
   ...
   message( ERROR " SYCL: Unsupported compiler family ${CMAKE_CXX_COMPILER_ID}!!")
...
function(SYCL_FEATURE_TEST_RUN TEST_EXE)
  ...
  if(test_result)
    message(ERROR "SYCL feature test execution failed!")
  endif()
...
if(nosycllang)
  message( ERROR " It appears that the ${CMAKE_CXX_COMPILER} does not support SYCL\n")
  set(SYCL_FOUND False)
endif()
...
find_package_handle_standard_args(
  ...
  REQUIRED_VARS SYCL_INCLUDE_DIR SYCL_LANGUAGE_VERSION)
